...
\end{tabular}
\footnotetext[1]{ Evaluated against the best gold standard sentence. }
\footnotetext[2]{ Evaluated against the best and secondary sentences. }
\footnotetext[3]{ Evaluated for only the first date. }
