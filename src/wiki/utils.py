...
def normalize_title(title):
    ...
    title = urllib.quote(title, safe="%") # force / to be quoted and % not to be quoted
...
def get_nfc(string):
    return urllib.quote(unicodedata.normalize("NFC",string.decode('utf8')).encode('utf8'), safe="%") # force / to be quoted and % not to be quoted
